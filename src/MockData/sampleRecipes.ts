...
export const sampleRecipes: Array<Recipe> = [
...

  {
    ...
    shortDescription: 'A deliciously indulgent shake blending the rich flavors of Kit Kat with creamy milk, creating a chocolaty delight. ',
  ...
  },
  {
    ...
    shortDescription: 'A wholesome and cheesy Indian wrap stuffed with spiced vegetables, tangy sauces, and grated cheese, for quick and tasty snack.',
...
},
{
  ...
  shortDescription: 'Crispy corn tortillas filled with a flavorful mix of beans, grilled veggies, cheese, and fresh salsa, along vibrant flavors.',
...
},
{
  ...
  shortDescription: 'Sushi rolls made with seasoned rice, crisp vegetables, and wrapped in seaweed,with touch of soy sauce for a delightful finish.   ',
...
},
{
  ...
  shortDescription: 'A crispy, golden-brown dosa stuffed with spiced potato filling, served with coconut chutney and sambar.With authentic south indian taste',
...
},
{
  ...
  shortDescription: 'A soft and fluffy steamed gram flour snack, lightly spiced and garnished with mustard seeds and curry leaves and green chutney',
...
},
{
  ...
  shortDescription: 'A rich and indulgent jar cake layered with moist chocolate cake, creamy frosting, and contrast of smoothness and satisfying crunch.',
...
},
{
  ...
  shortDescription: 'Shake made with Oreo cookies blended to perfection with milk and ice cream , Topped with whipped cream and crushed Oreo bits.',
